local att = {}
att.name = "rshd_pm2_1250_g28"
att.displayName = "Schmidt & Bender PM II 12x50 For HK"
att.displayNameShort = "G28"
att.aimPos = {"G28Pos", "G28Ang"}
att.FOVModifier = 5
att.isSight = true
...
if CLIENT then
	...
	att.displayIcon = surface.GetTextureID("vgui/icons/g28scope_vgui")
	att.description = {[1] = {t = "Provides magnification.", c = CustomizableWeaponry.textColors.POSITIVE},

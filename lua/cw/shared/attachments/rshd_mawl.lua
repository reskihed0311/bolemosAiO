local att = {}
att.name = "rshd_mawl"
att.displayName = "MAWL C1+"
att.displayNameShort = "MAWL"
att.laserRange = 4096
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("vgui/icons/mawl")
	att.description = {}
	...
	function att:elementRender()
		local model = self.AttachmentModelsVM.rshd_mawl.ent
		...
		angs = angs or self.MawlAngAdjust
		...
		local laserPos = pos + ang:Right() * self.MawlPosAdjust.x + ang:Forward() * self.MawlPosAdjust.y + ang:Up() * self.MawlPosAdjust.z

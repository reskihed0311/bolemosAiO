local att = {}
att.name = "rshd_anpeq2"
att.displayName = "AN/PEQ2"
att.displayNameShort = "PEQBOX 2"
att.laserRange = 4096
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("vgui/icons/rshd_anpeq2")
	att.description = {}
	...
	function att:elementRender()
		local model = self.AttachmentModelsVM.rshd_anpeq2.ent

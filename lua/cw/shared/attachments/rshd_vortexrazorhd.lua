local att = {}
att.name = "rshd_vortexrazorhd"
att.displayName = "VORTEX SMART Razor HD"
att.displayNameShort = "Razor HD"
att.aimPos = {"RAZPos", "RAZAng"}
att.FOVModifier = 15
att.isSight = true
att.SpeedDec = 5
...
if CLIENT then
	att.displayIcon = surface.GetTextureID("vgui/icons/rshd_vortexrazorhd")
	att.description = {[1] = {t = "Provides 1-8x magnification.", c = CustomizableWeaponry.textColors.POSITIVE},
	[2] = {t = "For medium to long ranges.", c = CustomizableWeaponry.textColors.NEGATIVE},

    }
	local old, x, y, ang
	local reticle = surface.GetTextureID("models/weapons/shared/atts/reticles/razorsight")
	
	att.zoomTextures = {{tex = surface.GetTextureID("models/weapons/shared/atts/reticles/razorsight"), offset = {0, 1}}}

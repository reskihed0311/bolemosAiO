local att = {}
att.name = "rshd_rorschsight"
att.displayName = "NORDVIK Rorsch Optic"
att.displayNameShort = "RORSCH"
att.aimPos = {"RORPos", "RORAng"}
att.FOVModifier = 15
att.isSight = true

if CLIENT then
	att.displayIcon = surface.GetTextureID("vgui/icons/rshd_rorschsight")
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.RORPos, self.RORAng, 1)

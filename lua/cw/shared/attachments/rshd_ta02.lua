local att = {}
att.name = "rshd_ta02"
att.displayName = "TRIJICON TA02"
att.displayNameShort = "ACOG"
att.aimPos = {"TA02Pos", "TA02Ang"}
att.FOVModifier = 15
att.isSight = true
...
if CLIENT then
	...
	att.displayIcon = surface.GetTextureID("vgui/icons/rshd_ta02")
	...
	local old, x, y, ang
	local sight = surface.GetTextureID("models/weapons/shared/atts/reticles/reticle_ta01")
	local sightIllum = surface.GetTextureID("models/weapons/shared/atts/reticles/reticle_ta01")

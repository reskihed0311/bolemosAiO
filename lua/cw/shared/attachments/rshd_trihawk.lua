local att = {}
att.name = "rshd_trihawk"
att.displayName = "SWAMPFOX TriHawk 3x30"
att.displayNameShort = "TRIHAWK"
att.aimPos = {"TRIPos", "TRIAng"}
att.FOVModifier = 5
att.isSight = true
att.statModifiers = {OverallMouseSensMult = -0.1}

if CLIENT then
	att.displayIcon = surface.GetTextureID("vgui/icons/sfox")
	...
	local old, x, y, ang
	local reticle = surface.GetTextureID("models/weapons/shared/atts/reticles/trihawkscope")
	
	att.zoomTextures = {{tex = surface.GetTextureID("models/weapons/shared/atts/reticles/trihawkscope"), offset = {0, 1}}}
